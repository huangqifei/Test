...
<body>
	...
	<form action="modifysightensure.do?id=${sight.id }" method="post">
		<table border="0" cellpadding="0" cellspacing="0" width="900" align="center">
			...
			<tr>
				<td style="padding-left:50px;padding-top:20px;"><input type="submit" value="确定"/></td>
				<td style="padding-left:50px;padding-top:20px;"><input type=button value="取消" onclick="javascript:history.back();"/></td>
