...
<body>
	...
	<table width="900" height="38" border="0" cellpadding="0" cellspacing="0" align="center">
		<tr height="37">
				<td width="98" align="left"><a href="adminsightlink.do"><img src="img/sight.gif"/></a></td>
				<td width="98" align="left"><a href="adminhotellink.do"><img src="img/hotel.gif"/></a></td>
				<td width="98" align="left"><a href="adminplanelink.do"><img src="img/plane.gif"/></a></td>
				<td width="98" align="left"><a href="adminbbslogo.do"><img src="img/bbs.gif"/></a></td>
				<td width="508" height="37" background="img/logoblank.gif" align="right">
					<font style="font-size: 15px;">
						...
						<c:if test="${!empty user}">
							<c:choose>
								...
								<c:otherwise>
									游客：<a href="user_info.jsp">${user.name }</a>&nbsp;|&nbsp;<a href="logout.do">退出</a>
								</c:otherwise>
							</c:choose>
						</c:if> 
					</font>
